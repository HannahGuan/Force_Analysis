...
class Force_analysis:
    ...
    def plot_distractorON(self):
        ...
        plt.plot(time_x, pc_prev_cong, label = "Prev Cong")
        #plt.plot(np.arange(len(pc_prev_neu)), pc_prev_neu, label = "Prev Neutral")
        plt.plot(time_x, pc_prev_inc, label = "Prev Incong")
        plt.legend()
        plt.title("Prime-Congruent Key")
        plt.ylim([320, 650])
        plt.show()

        plt.plot(time_x, pi_prev_cong, label = "Prev Cong")
        #plt.plot(np.arange(len(pi_prev_neu)), pi_prev_neu, label = "Prev Neutral")
        plt.plot(time_x, pi_prev_inc, label = "Prev Incong")
        plt.legend()
